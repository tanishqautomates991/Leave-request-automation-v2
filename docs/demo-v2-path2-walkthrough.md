...
[![Step 1: Form Submission](screenshots/step-01-google-form-submission.png)](screenshots/step-01-google-form-submission.png)

*Step 1: Form Submission*
> Employee submits the leave request through the Google Form, initiating the automation pipeline.

[![Step 2: Response Logged in Google Sheets](screenshots/step-02-data-in-google-sheets.png)](screenshots/step-02-data-in-google-sheets.png)

*Step 2: Response Logged in Google Sheets*
> The response lands in the sheet, triggering the n8n webhook.

[![Step 3: Path 2 Routing & Employee Database Lookup](screenshots/step-03-path2-employee-db-lookup.png)](screenshots/step-03-path2-employee-db-lookup.png)
...
[![Step 4: Edit Fields (Path 2) Output](screenshots/step-04-edit-fields-path2-output.png)](screenshots/step-04-edit-fields-path2-output.png)
...
[![Step 5: Full End-to-End Execution Diagram](screenshots/step-05-full-execution-diagram.png)](screenshots/step-05-full-execution-diagram.png)
...
[![Step 6: Agent Tool — Cache Memory Update](screenshots/step-06-agent-tool-cache-memory-update.png)](screenshots/step-06-agent-tool-cache-memory-update.png)
...
[![Step 8: Document Analysis Sub-workflow Diagram](screenshots/step-08-document-analysis-subworkflow-diagram.png)](screenshots/step-08-document-analysis-subworkflow-diagram.png)
...
[![Step 9: Agent Tool — Approval-Link Output](screenshots/step-09-agent-tool-approval-link-output.png)](screenshots/step-09-agent-tool-approval-link-output.png)
...
[![Step 10: Approval-Link Sub-workflow Diagram](screenshots/step-10-approval-link-subworkflow-diagram.png)](screenshots/step-10-approval-link-subworkflow-diagram.png)
...
[![Step 11: Agent Tool — Manager Gmail](screenshots/step-11-agent-tool-manager-gmail.png)](screenshots/step-11-agent-tool-manager-gmail.png)

*Step 11: Agent Tool — Manager Gmail Output*
> The Agent's Manager Gmail tool call, sending the manager their notification.

[![Step 12: Agent Tool — Employee Gmail](screenshots/step-12-agent-tool-employee-gmail.png)](screenshots/step-12-agent-tool-employee-gmail.png)
...
[![Step 13: Agent Tool — Update Manager's Approval Record](screenshots/step-13-agent-tool-update-manager-records.png)](screenshots/step-13-agent-tool-update-manager-records.png)
...
[![Step 14: Agent Final Node Output](screenshots/step-14-agent-final-node-output.png)](screenshots/step-14-agent-final-node-output.png)
...
[![Step 15: Manager's Email Inbox](screenshots/step-15-manager-email-inbox.png)](screenshots/step-15-manager-email-inbox.png)

*Step 15: Manager's Email Inbox*
> The notification email as it appears in the manager's inbox.

[![Step 16: Employee's Email Inbox](screenshots/step-16-employee-email-inbox.png)](screenshots/step-16-employee-email-inbox.png)

*Step 16: Employee's Email Inbox*
> The pending-confirmation email as it appears in the employee's inbox.

[![Step 17: Backend Confirmation Webhook Execution](screenshots/step-17-backend-confirmation-webhook-execution.png)](screenshots/step-17-backend-confirmation-webhook-execution.png)
...
[![Step 18: Manager's Browser — Request Approved](screenshots/step-18-manager-browser-approved.png)](screenshots/step-18-manager-browser-approved.png)

*Step 18: Manager's Browser Screen*
> The confirmation screen the manager sees after approving the request.

[![Step 19: Idempotency Check — Repeated Click](screenshots/step-19-idempotency-check-double-click.png)](screenshots/step-19-idempotency-check-double-click.png)
